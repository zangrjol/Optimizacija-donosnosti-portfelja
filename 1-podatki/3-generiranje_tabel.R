start.time <- Sys.time()
delnice <- read.csv2(file="podatki_cen.csv", header = TRUE, fileEncoding = "Windows-1250")
...
#shranimo
write.csv2(tabela1_cene,file="tabela1_cene.csv")
write.csv2(tabela2_spremembe,file="tabela2_spremembe.csv")
write.csv2(tabela3_sharpe,file="tabela3_sharpe.csv")
